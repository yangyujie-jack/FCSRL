...
def main():
    ...
    parser.add_argument('--hyperparams', type=str, default='hyper_params/TD3Repr_Lag_safety_gym.yaml')
    ...
    train_env_fn = lambda: make_env(env_cfg.name)
    test_env_fn = lambda: make_env(env_cfg.name)
